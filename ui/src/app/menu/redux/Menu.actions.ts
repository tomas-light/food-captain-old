...
import { LoadMenuActionPayload, SelectMenuActionPayload, SaveActionPayload } from './Menu.actions.types';
...
export class MenuActions {
	...
	static updateStore = (partialStore: Partial<MenuStore>) => createAction(MenuActions.UPDATE_STORE, partialStore);
