...
export class ValidatorBase {
	...
	protected static isNullOrEmptyString(value: string) {
		return ValidatorBase.isNullOrUndefined(value) || ValidatorBase.isEmptyString(value);
	}

	protected static isNullOrEmptyArray(value: number[]) {
		return ValidatorBase.isNullOrUndefined(value) || ValidatorBase.isEmptyArray(value);
	}
