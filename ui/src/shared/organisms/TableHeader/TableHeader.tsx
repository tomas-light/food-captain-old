...
import { Checkbox as MuiCheckbox, TableCell as MuiTableCell, TableHead as MuiTableHead, TableRow as MuiTableRow } from '@shared/reexport';
	...
	return (
		<MuiTableHead>
			<MuiTableRow>
				...
				{columns.map((column: ColumnSettings) =>
					column.sortable ? (
						<SortableColumn
						...
						<Column column={column} key={`header-${column.propertyName}`} />
					)
				)}
			</MuiTableRow>
		</MuiTableHead>
