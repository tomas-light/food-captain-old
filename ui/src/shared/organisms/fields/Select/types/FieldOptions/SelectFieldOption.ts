...
export class SelectFieldOption<TOptionValue = OptionValueType> implements FieldOption<TOptionValue, TOptionValue> {
	id: TOptionValue;
	title: string;
	...
	isNullOrEmptySingleValue(value: any): boolean {
		return value === null || value === undefined || value === this.emptySingleValue();
	}
