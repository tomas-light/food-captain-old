...
export class SelectStateFieldManager {
  ...
  getDisplayedSingleValue = (options: FieldOption<any, any>[], value: any)
    : FieldOption<any, any> => {
    ...
    const selectedOption: FieldOption = options.find(
      (option: FieldOption) => option.isEquals(value)
    );
  ...
  getDisplayedMultiValue = (options: FieldOption<any, any>[], value: any[])
    : FieldOption<any, any>[] => {
    ...
    const selectedOptions: FieldOption[] = options.filter(
      (option: FieldOption) =>
  ...
  getSelectedValue(
    option: FieldOption<any, any> | FieldOption<any, any>[],
  ...
  getSelectedSingleValue = (
    option: FieldOption<any, any>,
    action: ActionMeta<any>
  ): any => {
  ...
  public getSelectedMultiValues = (
    selectedOptions: FieldOption<any, any>[],
    action: ActionMeta<any>
  ): any[] => {
  ...
  isShrink = (meta: FieldMetaState<any>, value: FieldOption<any, any> | FieldOption<any, any>[]): boolean => {
    return meta.active
      || meta.modified
      || !this.isEmptySingleValue(value)
      && !this.isEmptyMultiValue(value);
  };
}
