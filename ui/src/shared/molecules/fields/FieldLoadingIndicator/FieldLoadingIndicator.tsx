...
const FieldLoadingIndicator = (props: Props) => {
	const { classes, visible, right = 12, ...rest } = props;

	return <Spinner visible={visible} size={loaderSize} className={classes.root} {...rest} />;
};
...
const componentWithStyles = withStyles<ClassKey>(styles, { name: 'FieldLoadingIndicator' })(FieldLoadingIndicator);

export { componentWithStyles as FieldLoadingIndicator };
export type { FieldLoadingIndicatorProps, ClassKey as FieldLoadingIndicatorClassKey };
